CREATE OR REPLACE PROCEDURE `river-water-quality-prediction.river_water_quality_dataset.sp_map_incoming_data`()

BEGIN

  CREATE OR REPLACE TABLE `river-water-quality-prediction.river_water_quality_dataset.mapped_incoming_river_water_quality`
  AS
  ...
  FROM `river-water-quality-prediction.river_water_quality_dataset.incoming_river_water_quality`;
